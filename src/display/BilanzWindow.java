...
public class BilanzWindow {
	...
	public BilanzWindow() {
		...
		JLabel kontostand = new JLabel("<html><body><center>Dein Kontostand <br>"
				+ Integer.toString(Start.bilanz.getGesamtkonto()) + "€</center></body></html>");
		JLabel gesamtplus = new JLabel("<html><body><center>Dein Gesamtplus <br>"
				+ Integer.toString(Start.bilanz.getGesamtplus()) + "€</center></body></html>");
		JLabel gesamtminus = new JLabel("<html><body><center>Dein Gesamtminus <br>"
				+ Integer.toString(Start.bilanz.getGesamtminus()) + "€</center></body></html>");
