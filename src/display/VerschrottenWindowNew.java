...
public class VerschrottenWindowNew extends JFrame {
	...
	public VerschrottenWindowNew() {
			...
			label[i].addActionListener(new java.awt.event.ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (Start.lager.Verschrotten(Start.window.getLagerplatzZuGrafiklagerplatz(temp))) {
						...
						Start.window.letzteAktion.setText("Letzte Aktion: Verschrotten von " + text + " in Lager "
		...
		lagertext.setText(
				"<html><center>W\u00E4hle ein Produkt aus, was verschrottet werden soll.<br><font color='red'>Verschrotten kostet <b>500\u20AC</b></font></center></html>");
